#include "C:\Users\shelt\AppData\Local\Temp\Temp1_original (7).zip\OpenGLCourseApp\OpenGLCourseApp\Shader.h"
#include "Shader.h"
	...
	if (lightCount > MAX_SPOT_LIGHTS)
	{
		...
		for (size_t i = 0; i < lightCount; i++)
		{
			sLight[i].UseLight(uniformSpotLight[i].uniformAmbientIntensity, uniformSpotLight[i].uniformColor, uniformSpotLight[i].uniformDiffuseIntensity,
				...
				uniformSpotLight[i].uniformLinear, uniformSpotLight[i].uniformPosition);
		}
	}
}
